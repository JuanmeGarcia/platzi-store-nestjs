...
export class NamingForeingKeys1694396776456 implements MigrationInterface {
    name = 'NamingForeingKeys1694396776456'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders_products" ADD "product_id" integer`);
        await queryRunner.query(`ALTER TABLE "orders_products" ADD "order_id" integer`);
